...
<div class="qr-wrap" style="margin:1rem 0;padding:1rem;border:1px solid #E5E7EB;border-radius:12px;">
  ...
  <input id="url" type="url" placeholder="https://forms.gle/REPLACE_IMMEDIATE" style="width:100%;padding:.6rem;border:1px solid #D1D5DB;border-radius:10px;">
...
(function() {
  ...
  const defaultURL = 'https://forms.gle/REPLACE_IMMEDIATE';
  ...
  document.getElementById('download').addEventListener('click', () => {
    ...
    a.href = qrURL;
    a.download = 'immediate-survey-qr.png';
